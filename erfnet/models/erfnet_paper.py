...
from erfnet.models.spatial_dropout import spatial_dropout
...
class ERFNetBasic(chainer.Chain):
    """ERFNet Basic for semantic segmentation."""
    def __init__(self, config, pretrained_model=None):
        super(ERFNetBasic, self).__init__()
        n_class = None
        this_mod = sys.modules[__name__]
